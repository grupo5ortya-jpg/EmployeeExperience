...
export default function OnboardingHome() {
    ...
    const siblings = useMemo(() => {
        ...
        if (!selected?.taskType?.id) {
            return []
        }

        return tasks.filter(
            (task) => task.taskType?.id === selected.taskType.id
        )
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-6 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-start">
                ...
                <div className="bg-white rounded-xl border border-brand-light shadow-sm overflow-hidden">
                    ...
                    {/* Top */}
                    <div className="px-5 py-4 border-b border-brand-light bg-brand-pale/40 flex flex-col gap-4">
