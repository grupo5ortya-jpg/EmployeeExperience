...
const HR_ALERT_TYPES       = ['NEGATIVE_PULSE_SIGNAL', 'FEEDBACK_CYCLE_COMPLETED', 'ONBOARDING_COMPLETED', 'ONBOARDING_TASK_SUBMITTED', 'ONBOARDING_TEMPLATE_SUBMITTED', 'ONBOARDING_TASK_OVERDUE', 'OKR_BEHIND_SCHEDULE', 'OKR_COMPLETED'];
const EMPLOYEE_ALERT_TYPES = ['PULSE_SURVEY_DUE', 'FEEDBACK_EVALUATION_READY', 'ONBOARDING_TASKS_ASSIGNED', 'ONBOARDING_TASK_SUBMITTED', 'ONBOARDING_TEMPLATE_APPROVED', 'TEAM_PULSE_ALERT', 'TEAM_TASK_OVERDUE', 'FEEDBACK_GAP_ANALYSIS_SENT', 'CONTINUOUS_FEEDBACK_RECEIVED', 'OKR_BEHIND_SCHEDULE', 'OKR_ASSIGNED'];
