...
const HR_ALERT_TYPES       = ['NEGATIVE_PULSE_SIGNAL', 'FEEDBACK_CYCLE_COMPLETED', 'ONBOARDING_COMPLETED', 'ONBOARDING_TASK_SUBMITTED', 'ONBOARDING_TEMPLATE_SUBMITTED', 'ONBOARDING_TASK_OVERDUE', 'OKR_BEHIND_SCHEDULE'];
